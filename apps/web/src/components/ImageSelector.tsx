...
import { ProcessedImage, Size } from '~/lib/types';
...
const getImageBlobFromEditor = (editor: AvatarEditor, type: string) => {
      ...
      for (const file of files) {
        if (file.editorRef) {
          results.push({
            id: file.id,
            file: file.file,
            blob: await getImageBlobFromEditor(file.editorRef, imageType),
          });
        }
      }
      return results;
